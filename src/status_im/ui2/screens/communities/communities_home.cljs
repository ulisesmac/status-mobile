...
(defn home-community-segments []
  [rn/view {:style {:padding-bottom     12
   ...
   [tabs/tabs {:size              32
               ...
               :default-active    :all
               :data [{:id :all   :label (i18n/label :chats/joined) :accessibility-label :joined-tab}
                      {:id :open  :label (i18n/label :t/pending)    :accessibility-label :pending-tab}
                      {:id :gated :label (i18n/label :t/opened)     :accessibility-label :opened-tab}]}]])
