   ...
   [rn/view {:flex-direction :row
    ...
    [rn/view {:flex 1}
     [quo2.tabs/tabs {:size           32
                      ...
                      :data           [{:id    :all
                                        :label (i18n/label :t/all)   :accessibility-label  :all-tab}
                                       {:id    :open
                                        :label (i18n/label :t/open)  :accessibility-label  :open-tab}
                                       {:id    :gated
                                        :label (i18n/label :t/gated) :accessibility-label  :gated-tab}]}]]
    [rn/view {:flex-direction :row}
     [quo2.button/button
      {:icon     true
       :type     :outline
       ...
       :accessibility-label :sort-communities-button}
      :main-icons2/flash]
     [quo2.button/button
      {:icon     true
       :type     :outline
       :size     32
       :accessibility-label :communities-view-type-button
