...
(defn community-filter-tags []
  (let [tags [{:id  1  :label (i18n/label      :t/music)     :resource  (resources/get-image :music)}
              ...
              {:id  4  :label "NFT"            :resource  (resources/get-image :music)}
              {:id  6  :label "Crypto"         :resource  (resources/get-image :lifestyle)}
              {:id  7  :label "DeFi"           :resource  (resources/get-image :podcasts)}
              {:id  8  :label "Politics"       :resource  (resources/get-image :music)}
              {:id  9  :label "Social"         :resource  (resources/get-image :lifestyle)}
              {:id  10 :label "Security"  :resource  (resources/get-image :podcasts)}]]
    [rn/view
     [rn/view {:flex-direction      :row
               :padding-horizontal  20
               :height              48
